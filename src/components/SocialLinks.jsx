...
const SocialLinks = () => {
  ...
  return (
    <div className='hidden xl:flex fixed flex-col top-[34%] left-0'>
            <ul>
            ...
            <ul>
                <li className='w-[150px] h-[50px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-200 bg-[#171616]'>
            ...
            <ul>
                <li className='w-[150px] h-[50px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-200 bg-[#68bba9]'>
            ...
            <ul>
                <li className='w-[150px] h-[50px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-200 bg-[#2f3133]'>
