...
const Home = () => {
  ...
  return (
    <div id="home" name="home" className='w-full h-150vh md:min-h-fit py-14 bg-gradient-to-b from-[#0a1a32] to-[#0c1f3c] md:py-14 sm:py-16 min-h-fit'>
        {/* container */}
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-screen px-4 md:flex-row'>
          <div className='flex flex-col justify-center h-full'>
            ...
            <p className=' text-gray-300 py-4 max-w-md text-xl'>Specializing in building Frontend of Websites and Web Applications that leads to the success of the overall product </p>
            <div>
